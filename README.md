# How To Use This Bot:
Invite this bot to your Discord using this URL so you get all the correct permissions.
https://discord.com/oauth2/authorize?client_id=1492262779112001558&scope=bot+applications.commands&permissions=4503874505353216

Use /spin or !spin followed by a WheelDecide.com link to an existing spin wheel.

Will also ping users if they post a WheelDecide link without using a spin command.
...
memory solely to generate a response:
  ...
  - The Discord username of the user who issued the command (for the
    purposes of the @mention in the result post)
...
available at https://railway.app/legal/privacy.
